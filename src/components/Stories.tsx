...
import { ArrowButton, CTA } from './Shared';
  ...
  return <section className="reviews-section" id="historias">
    ...
    <div className="reviews-layout section-content">
      ...
      <div className="reviews-stage" data-reveal>
        <ArrowButton className="reviews-arrow reviews-arrow-left" direction="left" onClick={() => go(-1)} aria-label="Avaliação anterior" />
        ...
        <ArrowButton className="reviews-arrow reviews-arrow-right" direction="right" onClick={() => go(1)} aria-label="Próxima avaliação" />
